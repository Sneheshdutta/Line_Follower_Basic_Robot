...
void loop() 
{if((!digitalRead(LIR))&&(digitalRead(CIR))&&!(digitalRead(RIR)))               //FORWARD
{
...
if((((digitalRead(LIR))&&(digitalRead(CIR)))||((digitalRead(LIR))||(digitalRead(CIR))))&&!(digitalRead(RIR)))            //LEFT
{
  digitalWrite(RLED,LOW);
...
if((((digitalRead(RIR))&&(digitalRead(CIR)))||((digitalRead(RIR))||(digitalRead(CIR))))&&!(digitalRead(LIR)))          //RIGHT
{
  digitalWrite(RLED,LOW);
